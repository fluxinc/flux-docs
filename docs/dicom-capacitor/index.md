...
- **Queue Prioritization**: Can optionally prioritize cached studies by SOP Class UID per storage destination in `nodes.yml`, while preserving FIFO order within the same priority level.

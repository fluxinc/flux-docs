...
- Location: `%ProgramData%\Flux Inc\DICOM Printer 2\log\`
...
See [Interrogating the Logs](logs.md) for help understanding log messages and finding issues.
...
4. **Include** logs showing the bug
5. **Note** workarounds if any

...
The Console + API stack is the operator surface. The `OpenQueueDashboard.exe` launcher and `dicom-printer-2-queue/` install directory are compatibility aliases for the Console.
